...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="./public/fontend/img/favicon.png">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" integrity="sha512-5A8nwdMOWrSz20fDsjczgUidUBR8liPYU+WymTZP1lmY9G6Oc7HlZv156XqnsgNUzTyMefFTcsFH/tnJE/+xBg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <!-- Place favicon.ico in the root directory -->

    <!-- CSS here -->
    <link rel="stylesheet" href="./public/fontend/css/bootstrap.min.css">
    <link rel="stylesheet" href="./public/fontend/css/animate.min.css">
    <link rel="stylesheet" href="./public/fontend/css/magnific-popup.css">
    <link rel="stylesheet" href="./public/fontend/css/fontawesome-all.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.css" integrity="sha512-5A8nwdMOWrSz20fDsjczgUidUBR8liPYU+WymTZP1lmY9G6Oc7HlZv156XqnsgNUzTyMefFTcsFH/tnJE/+xBg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="stylesheet" href="./public/fontend/css/flaticon.css">
    <link rel="stylesheet" href="./public/fontend/css/slick.css">
    <link rel="stylesheet" href="./public/fontend/css/aos.css">
    <link rel="stylesheet" href="./public/fontend/css/default.css">
...
<body class="theme-bg">
    ...
    <header>
                    ...
                    <div class="col-xl-12">
                        <div class="main-menu">
                            <nav class="navbar navbar-expand-lg">
                                <a href="index.html" class="navbar-brand logo-sticky-none"><img src="./public/fontend/img/logo/logo.png" alt="Logo"></a>
                                <a href="index.html" class="navbar-brand s-logo-none"><img src="./public/fontend/img/logo/s_logo.png" alt="Logo"></a>
        ...
        <div class="extra-info">
            ...
            <div class="logo-side mb-30">
                <a href="index-2.html">
                    <img src="./public/fontend/img/logo/logo.png" alt="" />
                </a>
            </div>
    ...
    <main>
        ...
        <section id="home" class="banner-area banner-bg fix">
            ...
            <div class="banner-shape"><img src="./public/fontend/img/shape/dot_circle.png" class="rotateme" alt="img"></div>
        </section>
        <!-- banner-area-end -->
        ...
        <section id="about" class="about-area primary-bg pt-120 pb-120">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="./public/fontend/img/banner/banner_img2.png" title="me-01" alt="me-01">
                        </div>
                    </div>
                    <div class="col-lg-6 pr-90">
                        ...
                        <div class="about-content">
                            <p>I am a professional MERN stack developer with a strong foundation in building full-stack web applications using MongoDB, Express.js, React.js, and Node.js. My expertise lies in designing and developing scalable, efficient, and user-friendly solutions that meet the unique needs of businesses and users alike.</p>
                            <h3>Education:</h3>
                        </div>
                        <!-- Education Item -->
                        <div class="education">
                            ...
                            <div class="location">
                                ...
                                <div class="progressWrapper">
                                    <div class="progress">
                                        <div class="progress-bar wow slideInLefts" data-wow-delay="0.2s" data-wow-duration="2s" role="progressbar" style="width: 80%;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="education">
                            ...
                            <div class="line"></div>
                            <div class="location">
                                <span>Master of Responsive Web Application</span>
                                <div class="progressWrapper">
                                    <div class="progress">
                                        <div class="progress-bar wow slideInLefts" data-wow-delay="0.2s" data-wow-duration="2s" role="progressbar" style="width: 90%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="education">
                            ...
                            <div class="line"></div>
                            <div class="location">
                                <span>Expert of Database Management</span>
                                <div class="progressWrapper">
                                    <div class="progress">
                                        <div class="progress-bar wow slideInLefts" data-wow-delay="0.2s" data-wow-duration="2s" role="progressbar" style="width: 65%;" aria-valuenow="85" aria-valuemin="0"
                        ...
                        <div class="testimonial-active">
                            <div class="single-testimonial text-center">
                                <div class="testi-avatar">
                                    <img src="./public/fontend/img/images/testi_avatar.png" alt="img">
                                </div>
                ...
                <div class="row brand-active">
                    <div class="col-xl-2">
                        <div class="single-brand">
                            <img src="./public/fontend/img/brand/brand_img01.png" alt="img">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="single-brand">
                            <img src="./public/fontend/img/brand/brand_img02.png" alt="img">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="single-brand">
                            <img src="./public/fontend/img/brand/brand_img03.png" alt="img">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="single-brand">
                            <img src="./public/fontend/img/brand/brand_img04.png" alt="img">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="single-brand">
                            <img src="./public/fontend/img/brand/brand_img05.png" alt="img">
                        </div>
                    </div>
                    <div class="col-xl-2">
                        <div class="single-brand">
    ...
    <!-- JS here -->
    <script src="./public/fontend/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="./public/fontend/js/popper.min.js"></script>
    <script src="./public/fontend/js/bootstrap.min.js"></script>
    <script src="./public/fontend/js/isotope.pkgd.min.js"></script>
    <script src="./public/fontend/js/one-page-nav-min.js"></script>
    <script src="./public/fontend/js/slick.min.js"></script>
    <script src="./public/fontend/js/ajax-form.js"></script>
    ...
    <script src="./public/fontend/js/jquery.counterup.min.js"></script>
    <script src="./public/fontend/js/jquery.scrollUp.min.js"></script>
    <script src="./public/fontend/js/imagesloaded.pkgd.min.js"></script>
