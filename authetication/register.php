        ...
        <div class="app-auth-container">
            ...
            <form action="manage.php" method="POST">
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input name="username" type="text" class="form-control m-b-md  <?php if (isset ($_SESSION ['name_error'])) {echo 'is-invalid'; } else { echo '';} ?>" value="<?= isset ( $_SESSION ['old_name']) ?  $_SESSION ['old_name'] : '' ?> " id="signUpUsername" aria-describedby="signUpUsername" placeholder="Enter Name"> 
                    ...
                    <input name="email" type="text" class="form-control m-b-md <?php if (isset ($_SESSION ['email_error'])) {echo 'is-invalid'; } else { echo '';} ?>" value="<?= isset ( $_SESSION ['old_email']) ?  $_SESSION ['old_email'] : '' ?>" id="signUpEmail" aria-describedby="signUpEmail" placeholder="example@neptune.com">
                    ...
                    <input name="password" type="password" class="form-control" value="<?= isset ( $_SESSION ['old_password']) ?  $_SESSION ['old_password'] : '' ?>" id="signUpPassword" aria-describedby="signUpPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
                    <div class="my-2">
                    ...
                    <input name="c_password" type="password" class="form-control" value="<?= isset ( $_SESSION ['old_c_password']) ?  $_SESSION ['old_c_password'] : '' ?>" id="signUpCPassword" aria-describedby="signUpPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
                    <div class="my-2">
                    <input type="checkbox" onclick="showCPass()">Show Password
                    </div>
