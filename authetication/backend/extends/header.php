        ...
        <div class="app-sidebar">
            ...
            <div class="app-menu">
                ...
                <a href="mailbox.html"><i class="material-icons-two-tone">inbox</i>Mailbox<span class="badge rounded-pill badge-danger float-end">87</span></a>
                    ...
                    <li class="<?= ($link == 'setting.php') ? 'active-page' : '' ?>">
                        <a href="../setting/setting.php"><i class="material-icons-two-tone">settings</i>Setting</a>
                    </li>
                        ...
                        <div class="d-flex">
                            <ul class="navbar-nav">
                                <li class="nav-item hidden-on-mobile">
                                    <a class="nav-link btn btn-primary text-white px-3" href="../../login.php"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
                                </li>
                                <!-- <li class="nav-item hidden-on-mobile">
