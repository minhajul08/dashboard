    ...
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <!-- register alert end-->
                   ...
                   <!-- login alert start -->
                   <?php if (isset ( $_SESSION ['login_unsuccess_error']))  {?>
            <div class=" alert alert-custom" role="alert">
            <div class="custom-alert-icon icon-danger"><i class="material-icons-outlined">done</i></div>
            <div class="alert-content">
                <br>
                <span class="alert-text">
                        <?php echo $_SESSION ['login_unsuccess_error'] ?>
                    </span>
                </div>
             </div>
             <?php }  unset ($_SESSION ['login_unsuccess_error']) ?> 
            <!-- login alert end-->
            ...
            <div class="auth-credentials m-b-xxl">
                ...
                <input type="text" class="form-control m-b-md" name="email" id="signInEmail" aria-describedby="signInEmail" >
                ...
                <input type="password" class="form-control" name="password" id="signInPassword" aria-describedby="signInPassword" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;">
            ...
            <div class="auth-submit">
                <button type="submit" name="login_btn" class="btn btn-primary" >Sign In</a>
            </div>
            </form>
